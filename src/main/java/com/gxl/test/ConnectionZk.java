...
public class ConnectionZk {
	...
	private ConnectionZk(String zk_address, int session_timeout, String usernamePath, String passwordPath) {
	...
	private void connection() {
		try {
			zk_client = new ZooKeeper(zk_address, session_timeout, new Watcher() {
				@Override
			...
			registerNode.register(zk_client, usernamePath, passwordPath);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
